...
/**
 * Estados del carrito con factory method para validar transiciones.
 * Aplica patrón Factory + State para garantizar transiciones válidas.
 */
public enum EstadoCarrito {
	...
	/**
	 * Factory method: valida y retorna el nuevo estado si la transición es válida.
	...
	/**
	 * Factory method con validación de negocio para pagos.
	 * Solo permite PAGADO si hay items en el carrito.
	 */
